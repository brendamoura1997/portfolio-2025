const ImageCard = ({ imageSrc, title }) => {
  return (
    <div
      className="relative w-[55vw] sm:w-[45vw] h-[80vw] sm:h-[75vw] max-w-[210px] sm:max-w-[190px] max-h-[320px] 
    ...
    >
      ...
      <div className="flex justify-center">
        <h3 className="py-4 sm:py-4 T1 md:py-1 text-[var(--light-cyan)] text-xl font-bold">
          {title}
        </h3>
      </div>
    </div>
