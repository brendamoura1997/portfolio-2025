...
const NeonButton = ({ width, paddingY, onClick, text }) => {
  return (
    <button
      onClick={onClick}
      className={`relative group ${width} cursor-pointer text-center ${paddingY} backdrop-blur-xl border-[0.5px] 
    ...
    >
      ...
      <span
        className="absolute bottom-0 left-1/2 w-full h-[0.5px] -translate-x-1/2 bg-gradient-to-r from-transparent 
